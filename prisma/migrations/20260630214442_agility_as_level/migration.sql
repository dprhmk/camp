...
INSERT INTO "new_Member" ("additionalContact", "address", "allergies", "build", "campId", "childPhone", "code", "communication", "createdAt", "creativity", "dateOfBirth", "firstName", "gender", "guardianName", "height", "id", "instagram", "isFromBelievingFamily", "isLeader", "isProfileComplete", "lastName", "medicalNotes", "medicalRestrictions", "mentalScore", "middleName", "otherSocial", "parentsPhone", "photoUrl", "physicalRestrictions", "physicalScore", "residenceType", "squadId", "strength", "telegram", "updatedAt") SELECT "additionalContact", "address", "allergies", "build", "campId", "childPhone", "code", "communication", "createdAt", "creativity", "dateOfBirth", "firstName", "gender", "guardianName", "height", "id", "instagram", "isFromBelievingFamily", "isLeader", "isProfileComplete", "lastName", "medicalNotes", "medicalRestrictions", "mentalScore", "middleName", "otherSocial", "parentsPhone", "photoUrl", "physicalRestrictions", "physicalScore", "residenceType", "squadId", "strength", "telegram", "updatedAt" FROM "Member";
DROP TABLE "Member";
